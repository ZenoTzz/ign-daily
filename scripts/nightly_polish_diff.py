...
def dict_candidate_id(en, cn):
    digest = hashlib.sha1(f'{en}\0{cn}'.encode('utf-8')).hexdigest()[:12]
...
def add_candidate(candidates, seen, *, date, article_id, article, en, cn, evidence, confidence='medium'):
